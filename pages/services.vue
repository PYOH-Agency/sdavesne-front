    ...
    <section class="py-20">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <div class="inline-flex items-center px-4 py-2 bg-tertiary-100 text-tertiary-800 rounded-full text-sm font-medium mb-4">
          ...
          <h1 class="text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Services d'
            <span class="text-transparent bg-clip-text bg-gradient-mixed">hypnose thérapeutique</span>
          </h1>
    ...
    <section class="pb-20">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div v-if="pending" class="text-center mb-8">
          <div class="inline-flex items-center px-4 py-2 bg-primary-50 text-primary-600 rounded-lg text-sm">

...
<template>
  ...
  <div>
    <main>
      ...
      <p class="description">
        Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://pyoh.sentry.io/issues/?project=4509850126123088">Issues Page</a>.
